...
import audio from '../audios/Faulty2.mp3'

const Faulty2 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Faulty2}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Faulty2.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Faulty2', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Faulty2