...
import audio from '../audios/Adbuild3.mp3'

const Adbuild3 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Adbuild3}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Adbuild3.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Adbuild3', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Adbuild3