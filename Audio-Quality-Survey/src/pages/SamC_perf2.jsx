...
import audio from '../audios/SamC_perf2.mp3'

const SamC_perf2 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.SamC_perf2}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.SamC_perf2.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('SamC_perf2', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default SamC_perf2