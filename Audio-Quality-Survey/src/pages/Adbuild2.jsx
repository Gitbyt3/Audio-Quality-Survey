...
import audio from '../audios/Adbuild2.mp3'

const Adbuild2 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Adbuild2}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Adbuild2.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Adbuild2', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Adbuild2