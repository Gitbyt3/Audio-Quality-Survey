...
import audio from '../audios/Adbuild5.mp3'

const Adbuild5 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Adbuild5}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Adbuild5.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Adbuild5', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Adbuild5