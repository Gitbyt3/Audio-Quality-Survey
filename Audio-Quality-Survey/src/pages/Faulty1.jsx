...
import audio from '../audios/Faulty1.mp3'

const Faulty1 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Faulty1}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Faulty1.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Faulty1', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Faulty1