...
import audio from '../audios/Adbuild4.mp3'

const Adbuild4 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Adbuild4}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Adbuild4.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Adbuild4', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Adbuild4