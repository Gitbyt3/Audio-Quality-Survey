...
import audio from '../audios/SamC2.mp3'

const SamC2 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = surveyData.SamC2 || {Score: '', Comment: ''}
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('SamC2', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default SamC2