...
import audio from '../audios/Adbuild1.mp3'

const Adbuild1 = () => {
    const { surveyData, updateSurveyData } = useSurvey()

    const initialData = {Score: 1, Comment: '', ...surveyData.Adbuild1}

    const [ formData, setFormData ] = useState(initialData)
    const [isTouched, setIsTouched] = useState(!!surveyData.Adbuild1.Score)
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            <PageNavigation onNavigate={() => updateSurveyData('Adbuild1', formData)} nextDisabled={!isFormComplete()} />
        </div>
    )
}

export default Adbuild1